package com.alibaba.datax.plugin.writer.spreadsheetwriter;
...
public class TxtFileWriter extends Writer {
    ...
    public static class Job extends Writer.Job {
        ...
        private void validateParameter() {
            this.writerSliceConfig.getNecessaryValue(
        ...
        public void prepare() {
            ...
            if ("truncate".equals(writeMode)) {
                ...
                LOG.info(String.format("由于您配置了writeMode append, 写入前不做清理工作, [%s] 目录下写入相应文件名前缀  [%s] 的文件", path, fileName));
